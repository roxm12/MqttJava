...
public class MainTest {
	...
	public static void main(String[] args) {
		...
		String broker="tcp://basserd2.iptime.org:1883";
	...
	/*
		...
		ArrayList<Thread> threads = new ArrayList<Thread>();
		 for(int i=0;i<10;i++){
			 ...
			 ,userName+Integer.toString(i),pwd+Integer.toString(i),jmsg));
			 t.start();
			threads.add(t);
		 }
		//String broker="tcp://ec2-13-124-32-71.ap-northeast-2.compute.amazonaws.com:1883";
